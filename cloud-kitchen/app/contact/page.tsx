    ...
    <main className="mx-auto max-w-2xl px-5 py-14 md:px-8 md:py-20">
      <div className="text-center">
        ...
        <p className="mx-auto mt-3 max-w-sm text-forest/70">
          ...
          to order?{" "}
          <Link href="/menu" className="focus-ring font-bold text-tomato underline">
            Head to the menu
          </Link>{" "}
          instead.
        </p>
      ...
      {submitted ? (
        <div className="mt-10 rounded-3xl border-2 border-forest/15 bg-card p-8 text-center">
          ...
          <p className="mt-2 text-forest/70">
            Thanks for reaching out to a small kitchen.
          </p>
        </div>
      ) : (
        <form
        ...
        >
          ...
          <button
            type="submit"
            className="focus-ring w-full rounded-full bg-tomato px-8 py-3 font-display text-sm font-bold text-cream transition hover:bg-forest"
          >
            Send Message
          </button>
        </form>
